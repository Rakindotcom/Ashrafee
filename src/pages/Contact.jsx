          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center bg-elegant-cream p-8 rounded-lg hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p>Food Booking <a href="tel:01978322743" className="text-orange hover:underline font-semibold">+880 01978 322 743</a></p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="bg-gray-200 p-8 rounded-lg shadow-lg">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange resize-none"
